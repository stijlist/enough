...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__24092_SHARP_){
return ((p1__24092_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__24092_SHARP_ === 'string');
}),class$__$1))){
...
var G__24094 = attrs;
var G__24094__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__24094,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__24094);
return G__24094__$1;
});
/**
...
var len__17863__auto___24098 = arguments.length;
var i__17864__auto___24099 = (0);
while(true){
if((i__17864__auto___24099 < len__17863__auto___24098)){
args__17870__auto__.push((arguments[i__17864__auto___24099]));

var G__24100 = (i__17864__auto___24099 + (1));
i__17864__auto___24099 = G__24100;
continue;
} else {
}
break;
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__24095_SHARP_);
});})(maps__$1))
...
var G__24097 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__24097__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__24097,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__24097);
return G__24097__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq24096){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24096));
});
/**
...
var vec__24104 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__24104,(0),null);
var names = cljs.core.nth.call(null,vec__24104,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__24104,tag_name,names){
return (function (p1__24101_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__24101_SHARP_));
});})(matches,vec__24104,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__24104,tag_name,names){
return (function (p1__24102_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__24102_SHARP_));
});})(matches,vec__24104,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__24105){
var vec__24108 = p__24105;
var tag = cljs.core.nth.call(null,vec__24108,(0),null);
var content = cljs.core.nthnext.call(null,vec__24108,(1));
...
var vec__24109 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__24109,(0),null);
var id = cljs.core.nth.call(null,vec__24109,(1),null);
var class$ = cljs.core.nth.call(null,vec__24109,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1457416898733