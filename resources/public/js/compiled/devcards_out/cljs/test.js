...
var args27781 = [];
var len__17877__auto___27785 = arguments.length;
var i__17878__auto___27786 = (0);
while(true){
if((i__17878__auto___27786 < len__17877__auto___27785)){
args27781.push((arguments[i__17878__auto___27786]));

var G__27787 = (i__17878__auto___27786 + (1));
i__17878__auto___27786 = G__27787;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args27781.length)].join('')));
...
var G__27784 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__27784__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__27784,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__27784);
return G__27784__$1;
});
...
var len__17877__auto___27792 = arguments.length;
var i__17878__auto___27793 = (0);
while(true){
if((i__17878__auto___27793 < len__17877__auto___27792)){
args__17884__auto__.push((arguments[i__17878__auto___27793]));

var G__27794 = (i__17878__auto___27793 + (1));
i__17878__auto___27793 = G__27794;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27789){
var G__27790 = cljs.core.first.call(null,seq27789);
var seq27789__$1 = cljs.core.next.call(null,seq27789);
var G__27791 = cljs.core.first.call(null,seq27789__$1);
var seq27789__$2 = cljs.core.next.call(null,seq27789__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__27790,G__27791,seq27789__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__27798,map__27798__$1,file,line,column){
return (function (p1__27795_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27795_SHARP_));
});})(map__27798,map__27798__$1,file,line,column))
...
var temp__4425__auto___27800 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___27800)){
var message_27801 = temp__4425__auto___27800;
cljs.core.println.call(null,message_27801);
} else {
}
...
var temp__4425__auto___27802 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___27802)){
var message_27803 = temp__4425__auto___27802;
cljs.core.println.call(null,message_27803);
} else {
}
...
var G__27809 = exception.stack;
var G__27809__$1 = (((G__27809 == null))?null:clojure.string.split_lines.call(null,G__27809));
var G__27809__$2 = (((G__27809__$1 == null))?null:cljs.core.get.call(null,G__27809__$1,depth));
var G__27809__$3 = (((G__27809__$2 == null))?null:clojure.string.trim.call(null,G__27809__$2));
return G__27809__$3;
} else {
...
var vec__27810 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27810,(0),null);
var column = cljs.core.nth.call(null,vec__27810,(1),null);
var vec__27811 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27811,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27811,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27811,(2),null);
...
var m__$1 = (function (){var G__27813 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__27813) {
case "fail":
...
var G__27819 = (function (){var G__27818 = cljs.core.rest.call(null,fns);
var G__27818__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__27818):G__27818);
return G__27818__$1;
})();
fns = G__27819;
continue;
...
var G__27821 = fns;
var G__27821__$1 = (((G__27821 == null))?null:cljs.core.vary_meta.call(null,G__27821,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__27821__$1;
});
...
}catch (e27824){var e = e27824;
var G__27825 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__27825) {
...
var vec__27828 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27828,(0),null);
var types = vec__27828;
...
return cljs.core.map.call(null,(function (p__27836){
var vec__27837 = p__27836;
var ns = cljs.core.nth.call(null,vec__27837,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27837,(1),null);
return ((function (vec__27837,ns,vars__$1){
return (function (){
...
var G__27838 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__27838) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1){
return (function (){
var seq__27839 = cljs.core.seq.call(null,vars__$1);
var chunk__27840 = null;
var count__27841 = (0);
var i__27842 = (0);
while(true){
if((i__27842 < count__27841)){
var v = cljs.core._nth.call(null,chunk__27840,i__27842);
var temp__4425__auto___27844 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___27844)){
var t_27845 = temp__4425__auto___27844;
each_fixture_fn.call(null,((function (seq__27839,chunk__27840,count__27841,i__27842,t_27845,temp__4425__auto___27844,v,each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27845)));
});})(seq__27839,chunk__27840,count__27841,i__27842,t_27845,temp__4425__auto___27844,v,each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1))
);
} else {
}

var G__27846 = seq__27839;
var G__27847 = chunk__27840;
var G__27848 = count__27841;
var G__27849 = (i__27842 + (1));
seq__27839 = G__27846;
chunk__27840 = G__27847;
count__27841 = G__27848;
i__27842 = G__27849;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__27839);
if(temp__4425__auto__){
var seq__27839__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27839__$1)){
var c__17622__auto__ = cljs.core.chunk_first.call(null,seq__27839__$1);
var G__27850 = cljs.core.chunk_rest.call(null,seq__27839__$1);
var G__27851 = c__17622__auto__;
var G__27852 = cljs.core.count.call(null,c__17622__auto__);
var G__27853 = (0);
seq__27839 = G__27850;
chunk__27840 = G__27851;
count__27841 = G__27852;
i__27842 = G__27853;
continue;
} else {
var v = cljs.core.first.call(null,seq__27839__$1);
var temp__4425__auto___27854__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___27854__$1)){
var t_27855 = temp__4425__auto___27854__$1;
each_fixture_fn.call(null,((function (seq__27839,chunk__27840,count__27841,i__27842,t_27855,temp__4425__auto___27854__$1,v,seq__27839__$1,temp__4425__auto__,each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27855)));
});})(seq__27839,chunk__27840,count__27841,i__27842,t_27855,temp__4425__auto___27854__$1,v,seq__27839__$1,temp__4425__auto__,each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1))
);
} else {
}

var G__27856 = cljs.core.next.call(null,seq__27839__$1);
var G__27857 = null;
var G__27858 = (0);
var G__27859 = (0);
seq__27839 = G__27856;
chunk__27840 = G__27857;
count__27841 = G__27858;
i__27842 = G__27859;
continue;
}
} else {
...
});})(each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1))
);
});})(each_fixture_fn,G__27838,env,once_fixtures,each_fixtures,vec__27837,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1460363591650