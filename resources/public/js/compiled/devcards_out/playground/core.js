...
playground.core.years_til_retirement = (function playground$core$years_til_retirement(p__33760){
var map__33763 = p__33760;
var map__33763__$1 = ((((!((map__33763 == null)))?((((map__33763.cljs$lang$protocol_mask$partition0$ & (64))) || (map__33763.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33763):map__33763);
var salary = cljs.core.get.call(null,map__33763__$1,new cljs.core.Keyword(null,"salary","salary",1283904063));
var expenses = cljs.core.get.call(null,map__33763__$1,new cljs.core.Keyword(null,"expenses","expenses",-63975799));
var rate_of_return = cljs.core.get.call(null,map__33763__$1,new cljs.core.Keyword(null,"rate-of-return","rate-of-return",592356691));
var cutoff = cljs.core.get.call(null,map__33763__$1,new cljs.core.Keyword(null,"cutoff","cutoff",316921213));
...
cljs.core.print.call(null,cutoff);
...
var G__33765 = cljs.core.conj.call(null,years,new_balance);
years = G__33765;
continue;
}
break;
...
playground.core.multiplier = (function playground$core$multiplier(p__33766,p__33767){
var vec__33770 = p__33766;
var domain_start = cljs.core.nth.call(null,vec__33770,(0),null);
var domain_end = cljs.core.nth.call(null,vec__33770,(1),null);
var vec__33771 = p__33767;
var range_start = cljs.core.nth.call(null,vec__33771,(0),null);
var range_end = cljs.core.nth.call(null,vec__33771,(1),null);
return ((range_end - range_start) / (domain_end - domain_start));
});
playground.core.offset = (function playground$core$offset(p__33772,p__33773){
var vec__33776 = p__33772;
var domain_start = cljs.core.nth.call(null,vec__33776,(0),null);
var domain_end = cljs.core.nth.call(null,vec__33776,(1),null);
var vec__33777 = p__33773;
var range_start = cljs.core.nth.call(null,vec__33777,(0),null);
var range_end = cljs.core.nth.call(null,vec__33777,(1),null);
return (range_start - domain_start);
});
playground.core.linear_scale = (function playground$core$linear_scale(p__33778,p__33779){
var vec__33782 = p__33778;
var domain_start = cljs.core.nth.call(null,vec__33782,(0),null);
var domain_end = cljs.core.nth.call(null,vec__33782,(1),null);
var vec__33783 = p__33779;
var range_start = cljs.core.nth.call(null,vec__33783,(0),null);
var range_end = cljs.core.nth.call(null,vec__33783,(1),null);
...
return ((function (multiplier,offset,vec__33782,domain_start,domain_end,vec__33783,range_start,range_end){
return (function (domain){
return (offset + (multiplier * domain));
});
;})(multiplier,offset,vec__33782,domain_start,domain_end,vec__33783,range_start,range_end))
});
...
var pred__33787 = cljs.core._EQ_;
var expr__33788 = cljs.core.type.call(null,orig);
if(cljs.core.truth_(pred__33787.call(null,Number,expr__33788))){
return Number(v);
} else {
if(cljs.core.truth_(pred__33787.call(null,String,expr__33788))){
return String(v);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__33788)].join('')));
}
}
});
playground.core.editable_parameter = (function playground$core$editable_parameter(state,p__33791){
var vec__33793 = p__33791;
var k = cljs.core.nth.call(null,vec__33793,(0),null);
var v = cljs.core.nth.call(null,vec__33793,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onClick","onClick",-1991238530),((function (value,editing_QMARK_,vec__33793,k,v){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing","editing",1365491601)], null),((function (value,editing_QMARK_,vec__33793,k,v){
return (function (ks){
...
return React.createElement("div",null,null,React.createElement("div",null,null,sablono.interpreter.interpret.call(null,cljs.core.map.call(null,cljs.core.partial.call(null,playground.core.editable_parameter,state),cljs.core.dissoc.call(null,cljs.core.deref.call(null,state),new cljs.core.Keyword(null,"editing","editing",1365491601))))),(function (){var attrs33794 = ((cljs.core.not_every_QMARK_.call(null,cljs.core.number_QMARK_,playground.core.retirement_vals.call(null,cljs.core.deref.call(null,state))))?"Waiting...":playground.core.column_chart.call(null,playground.core.years_til_retirement.call(null,cljs.core.deref.call(null,state)),(420),(150)));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs33794))?sablono.interpreter.attributes.call(null,attrs33794):null),cljs.core.remove.call(null,cljs.core.nil_QMARK_,((cljs.core.map_QMARK_.call(null,attrs33794))?cljs.core.PersistentVector.EMPTY:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs33794)], null))));
})());
...
//# sourceMappingURL=core.js.map?rel=1460404569125