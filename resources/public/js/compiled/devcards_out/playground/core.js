...
playground.core.years_til_retirement = (function playground$core$years_til_retirement(p__33806){
...
var salary = cljs.core.get.call(null,map__33809__$1,new cljs.core.Keyword(null,"salary","salary",1283904063));
var expenses = cljs.core.get.call(null,map__33809__$1,new cljs.core.Keyword(null,"expenses","expenses",-63975799));
var rate_of_return = cljs.core.get.call(null,map__33809__$1,new cljs.core.Keyword(null,"rate-of-return","rate-of-return",592356691));
var cutoff = cljs.core.get.call(null,map__33809__$1,new cljs.core.Keyword(null,"cutoff","cutoff",316921213));
...
var G__33811 = cljs.core.conj.call(null,years,new_balance);
years = G__33811;
continue;
}
break;
...
playground.core.linear_scale = (function playground$core$linear_scale(p__33812,p__33813){
var vec__33816 = p__33812;
var domain_start = cljs.core.nth.call(null,vec__33816,(0),null);
var domain_end = cljs.core.nth.call(null,vec__33816,(1),null);
var vec__33817 = p__33813;
var range_start = cljs.core.nth.call(null,vec__33817,(0),null);
var range_end = cljs.core.nth.call(null,vec__33817,(1),null);
var multiplier = ((range_end - range_start) / (domain_end - domain_start));
var offset = (range_start - domain_start);
return ((function (multiplier,offset,vec__33816,domain_start,domain_end,vec__33817,range_start,range_end){
return (function (domain){
return (offset + (multiplier * domain));
});
;})(multiplier,offset,vec__33816,domain_start,domain_end,vec__33817,range_start,range_end))
});
...
var pred__33821 = cljs.core._EQ_;
var expr__33822 = cljs.core.type.call(null,orig);
if(cljs.core.truth_(pred__33821.call(null,Number,expr__33822))){
return Number(v);
} else {
if(cljs.core.truth_(pred__33821.call(null,String,expr__33822))){
return String(v);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__33822)].join('')));
}
}
});
playground.core.editable_parameter = (function playground$core$editable_parameter(state,p__33825){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onClick","onClick",-1991238530),((function (value,editing_QMARK_,vec__33827,k,v){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing","editing",1365491601)], null),((function (value,editing_QMARK_,vec__33827,k,v){
return (function (ks){
...
return React.createElement("div",null,null,React.createElement("div",null,null,sablono.interpreter.interpret.call(null,cljs.core.map.call(null,cljs.core.partial.call(null,playground.core.editable_parameter,state),cljs.core.dissoc.call(null,cljs.core.deref.call(null,state),new cljs.core.Keyword(null,"editing","editing",1365491601))))),(function (){var attrs33828 = ((cljs.core.not_every_QMARK_.call(null,cljs.core.number_QMARK_,playground.core.retirement_vals.call(null,cljs.core.deref.call(null,state))))?"Waiting...":playground.core.column_chart.call(null,playground.core.years_til_retirement.call(null,cljs.core.deref.call(null,state)),(420),(150)));
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs33828))?sablono.interpreter.attributes.call(null,attrs33828):null),cljs.core.remove.call(null,cljs.core.nil_QMARK_,((cljs.core.map_QMARK_.call(null,attrs33828))?cljs.core.PersistentVector.EMPTY:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs33828)], null))));
})());
...
//# sourceMappingURL=core.js.map?rel=1460404757756